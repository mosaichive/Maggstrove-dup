...
import { womenTops, TopProduct } from "@/data/womenTops";
...
interface AdminPriceEditorProps {
  product: TopProduct & { price: number };
...
const WomenTopsPage = () => {
  ...
  const [products, setProducts] = useState<TopProduct[]>(womenTops);
        ...
        <div className="bg-muted/50 border-b border-border">
          <div className="container mx-auto px-4 py-2.5 flex items-start gap-2">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Auto-pricing active.</strong> Each top is priced between{" "}
