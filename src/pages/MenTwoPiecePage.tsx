...
import { menTwoPiece, TwoPieceProduct } from "@/data/menTwoPiece";
...
const AdminPriceEditor = ({
  ...
  product: TwoPieceProduct & { price: number };
...
const MenTwoPiecePage = () => {
  const { isAdmin } = useAuth();
  const { isAvailable } = useProductOverrides();
  const [products, setProducts] = useState<TwoPieceProduct[]>(menTwoPiece);
        ...
        <div className="bg-secondary py-10 md:py-14">
          <div className="container mx-auto px-4 text-center">
            <nav className="text-sm text-muted-foreground mb-3">
              ...
              <span className="mx-2">/</span>
              <span className="text-foreground">2 Piece</span>
            </nav>
            <h1 className="text-2xl md:text-4xl font-bold tracking-tight mb-2">2 Piece Matching Sets</h1>
            <p className="text-muted-foreground max-w-xl mx-auto text-sm">
              Coordinated polo & shorts sets for effortless summer style.
            </p>
          </div>
        </div>
        ...
        <div className="bg-muted/50 border-b border-border">
          <div className="container mx-auto px-4 py-2.5 flex items-start gap-2">
            ...
            <p className="text-[11px] text-muted-foreground leading-relaxed">
              <strong className="text-foreground">Auto-pricing active.</strong> Each set is priced between{" "}
...
export default MenTwoPiecePage;
